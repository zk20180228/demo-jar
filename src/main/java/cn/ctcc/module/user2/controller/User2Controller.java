 ...
 * @Description: 这不是标准的demo,标准的demo是user1
 */
@Slf4j
@RestController
...
public class User2Controller extends BaseController {
    ...
    public BackResult insert(User2 user)throws Exception{

        user = new User2("测试","root", "13333432802", "13333432803@qq.com", new Date(), new Date());
